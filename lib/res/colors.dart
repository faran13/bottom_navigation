...
class AppColors{
  //Four main colors
  static const SSGrey = Color.fromRGBO(45, 52, 54, 1);
  static const SSGreyLight = Color.fromRGBO(99, 110, 114, .9);
  static const SSLoginBtn = Color.fromRGBO(15, 14, 14, .9);
  static const appYellow = Color.fromRGBO(255, 216, 93, 1);
  ...
  static final shadowColor= Color.fromRGBO(99, 110, 114, 0.91);
  static final shadowColorBlack= Color.fromRGBO(45, 52, 54, 1);
